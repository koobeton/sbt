...
public class FixedThreadPoolTest {
    ...
    public void taskTest() throws Exception {
        ...
        Map<Integer, String> callbackResults = new ConcurrentHashMap<>();

        Consumer<Integer> task = (i) -> callbackResults.put(i, Thread.currentThread().getName());
        ...
        assertEquals(20, callbackResults.size());
        assertEquals(20, callbackResults.keySet().size());
        assertEquals(nThreads, callbackResults.values().stream().distinct().count());
    }
}